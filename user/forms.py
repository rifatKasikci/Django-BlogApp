...
class RegisterForm(forms.Form):
    ...
    confirm = forms.CharField(max_length=50,label="Parola",widget=forms.PasswordInput)  
...
class LoginForm(forms.Form):
    ...
    password = forms.CharField(max_length=50,label="Parola",widget=forms.PasswordInput(attrs={"class":"form-control"}))
